...
#define GVSP_PIX_MONO           0x01000000                                          ///<判断是否为MONO格式的掩码
#define GVSP_PIX_OCCUPY8BIT     0x00080000                                          ///<判断一个像素有效位数是否是8位
#define GVSP_PIX_OCCUPY16BIT    0x00100000                                          ///<判断一个像素有效位数是否是16位
#define GVSP_PIX_MONO8          (GVSP_PIX_MONO | GVSP_PIX_OCCUPY8BIT  | 0x0001)     ///<MONO8格式
#define GVSP_PIX_MONO16         (GVSP_PIX_MONO | GVSP_PIX_OCCUPY16BIT | 0x0007)     ///<MONO16格式 
...
private:
    ...
    /// 获取控件使能状态
    void __GetControlStatus(char* chFeature, bool &bIsEnable);
};
