...
public:
	...
	tSdkImageResolution   m_sRoiResolution;//自定义ROI参数
	BOOL InitCamera();

	BOOL m_bEnableTransferRoi1;
	BOOL m_bEnableTransferRoi2;
	BOOL m_bEnableTransferRoi3;
	BOOL m_bEnableTransferRoi4;

	afx_msg void OnBnClickedEnableTranferRoi1();
	afx_msg void OnBnClickedEnableTranferRoi2();
	afx_msg void OnBnClickedEnableTranferRoi3();
	afx_msg void OnBnClickedEnableTranferRoi4();

	afx_msg void OnBnClickedButtonUpdateTransferRoi1();
	afx_msg void OnBnClickedButtonUpdateTransferRoi2();
	afx_msg void OnBnClickedButtonUpdateTransferRoi3();
	afx_msg void OnBnClickedButtonUpdateTransferRoi4();

	UINT m_TransforRoi1_x1;
	UINT m_TransforRoi1_x2;
	UINT m_TransforRoi1_y1;
	UINT m_TransforRoi1_y2;
	UINT m_TransforRoi2_x1;
	UINT m_TransforRoi2_x2;
	UINT m_TransforRoi2_y1;
	UINT m_TransforRoi2_y2;
	UINT m_TransforRoi3_x1;
	UINT m_TransforRoi3_x2;
	UINT m_TransforRoi3_y1;
	UINT m_TransforRoi3_y2;
	UINT m_TransforRoi4_x1;
	UINT m_TransforRoi4_x2;
	UINT m_TransforRoi4_y1;
	UINT m_TransforRoi4_y2;
